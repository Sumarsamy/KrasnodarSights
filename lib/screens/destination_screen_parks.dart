...
class DestinationScreenParks extends StatefulWidget{
  final Destination destination;

  DestinationScreenParks({required this.destination});

  @override
  _DestinationScreenParksState createState() => _DestinationScreenParksState();
}

class _DestinationScreenParksState extends State<DestinationScreenParks> {
