...
class CafeScreenBars extends StatefulWidget{
  final Cafe cafe;

  CafeScreenBars({required this.cafe});

  @override
  _CafeScreenBarsState createState() => _CafeScreenBarsState();
}

class _CafeScreenBarsState extends State<CafeScreenBars> {
