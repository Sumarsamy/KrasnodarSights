...
class DestinationScreenTheatres extends StatefulWidget{
  final Destination destination;

  DestinationScreenTheatres({required this.destination});

  @override
  _DestinationScreenTheatresState createState() => _DestinationScreenTheatresState();
}

class _DestinationScreenTheatresState extends State<DestinationScreenTheatres> {
