...
class DestinationScreenMonuments extends StatefulWidget{
  final Destination destination;

  DestinationScreenMonuments({required this.destination});

  @override
  _DestinationScreenMonumentsState createState() => _DestinationScreenMonumentsState();
}

class _DestinationScreenMonumentsState extends State<DestinationScreenMonuments> {
